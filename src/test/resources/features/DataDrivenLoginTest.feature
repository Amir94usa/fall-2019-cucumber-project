Feature: User account tests
  ...
  Scenario: Verify user information
    ...
    Then account holder name should be "Test Librarian 21"

  Scenario: Verify users information
    Given I am on the login page
    When I login using "student22@library" and "us2rddSF"
    Then account holder name should be "Test Student 22"


  Scenario Outline: Verify users information <email>
    Given I am on the login page
